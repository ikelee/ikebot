...
export class OpenClawApp extends LitElement {
  ...
  @state() routingEvents: RoutingEventEntry[] = [];
  private routingEventsBuffer: RoutingEventEntry[] = [];
  @state() routingReplayEntry: RoutingEventEntry | null = null;
  ...
  @state() chatLastCompletedAt: number | null = null;
  ...
  private agentTestScrollFrame: number | null = null;
