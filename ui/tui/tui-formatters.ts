...
/** Re-export from gateway for TUI consumers; local implementation uses composeThinkingAndContent for display. */
export const extractTextFromMessage = extractTextFromMessageGateway;
