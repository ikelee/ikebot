...
vi.mock("../../../../runtime/model-catalog.js", () => modelCatalogMocks);

import { loadSessionStore } from "../../../../infra/config/sessions.js";
import { abortEmbeddedPiRun, runEmbeddedPiAgent } from "../../../../runtime/pi-embedded.js";
...
describe("trigger handling", () => {
  it("shows a /model summary and points to /models", async () => {
    await withTempHome(async (home) => {
      ...
      expect(normalized).toMatch(/\/model <provider\/model>/);
      expect(normalized).toMatch(/\/model status/);
  ...
  it("rejects invalid /model <#> selections", async () => {
    await withTempHome(async (home) => {
      ...
      expect(normalized).toMatch(/\/models/);
      expect(normalized).toMatch(/\/model <provider\/model>/);
