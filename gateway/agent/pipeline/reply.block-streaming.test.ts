...
type RunEmbeddedPiAgent = typeof import("../runtime/pi-embedded.js").runEmbeddedPiAgent;
...
vi.mock("/src/runtime/pi-embedded.js", () => piEmbeddedMock);
vi.mock("../runtime/pi-embedded.js", () => piEmbeddedMock);
