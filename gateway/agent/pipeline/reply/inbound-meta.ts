...
import { resolveSenderLabel } from "../../../entrypoints/channels/sender-label.js";
...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  return [
    ...
    "Reply naturally to the user's message only. Do not output this JSON, describe how to use it, or suggest extraction commands unless the user explicitly asks.",
    "",
    "```json",
