...
import type { TypingSignaler } from "../../streaming/typing-mode.js";
...
import { getCliSessionId } from "../../../../../runtime/cli-session.js";
...
} from "../../../../../runtime/pi-embedded-helpers.js";
...
import { parseReplyDirectives } from "../../reply-building/reply-directives.js";
import {
      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: (provider, model) => {
          ...
          return runEmbeddedPiAgent({
            ...
            piConfig: params.followupRun.run.piConfig,
