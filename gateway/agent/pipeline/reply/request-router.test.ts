...
describe("phase 1 routing classifier", () => {
  ...
  it("detects simple conversational inputs", { timeout: 60_000 }, async () => {
  ...
  it("detects permission and capability queries as simple", { timeout: 60_000 }, async () => {
    const { phase1Classify } = await import("./phases/routing/phase-1.js");
    const model = await setupClassifierModel(mockConfig);
  ...
  it("detects job execution requests as escalate", { timeout: 60_000 }, async () => {
    const { phase1Classify } = await import("./phases/routing/phase-1.js");
    const model = await setupClassifierModel(mockConfig);
  ...
  it("detects calendar and data queries as escalate", { timeout: 60_000 }, async () => {
    const { phase1Classify } = await import("./phases/routing/phase-1.js");
    const model = await setupClassifierModel(mockConfig);
  ...
  it("detects code and tool requests as escalate", { timeout: 60_000 }, async () => {
    const { phase1Classify } = await import("./phases/routing/phase-1.js");
    const model = await setupClassifierModel(mockConfig);
  ...
  it("detects basic commands as simple", { timeout: 60_000 }, async () => {
    const { phase1Classify } = await import("./phases/routing/phase-1.js");
