...
import { resolveAutoImageModel } from "../../agent/media-understanding/runner.js";
import { logVerbose } from "../../globals.js";
import { STATE_DIR } from "../../infra/config/paths.js";
import { loadJsonFile, saveJsonFile } from "../../infra/json-file.js";
import { resolveApiKeyForProvider } from "../../models/model-auth.js";
...
export async function describeStickerImage(params: DescribeStickerParams): Promise<string | null> {
  ...
  try {
    ...
    const { describeImageWithModel } =
      await import("../../agent/media-understanding/providers/image.js");
