...
import { DEFAULT_BOOTSTRAP_FILENAME } from "../../../runtime/workspace.js";
...
vi.mock("../infra/config/config.js", async (importActual) => {
  const actual = await importActual<typeof import("../../infra/config/config.js")>();
  return {
    ...actual,
