...
vi.mock("../../pipeline/reply/provider-dispatcher.js", () => ({
...
vi.mock("../../runtime/identity.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../runtime/identity.js")>();
  return {
    ...actual,
