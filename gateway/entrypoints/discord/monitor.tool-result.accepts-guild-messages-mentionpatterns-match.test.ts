...
vi.mock("../pipeline/dispatch.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../pipeline/dispatch.js")>();
  return {
    ...actual,
...
describe("discord tool result dispatch", () => {
  it(
    ...
    async () => {
      ...
      } as ReturnType<typeof import("../infra/config/config.js").loadConfig>;
