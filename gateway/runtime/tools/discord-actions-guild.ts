...
import type { DiscordActionConfig } from "../../infra/config/config.js";
import { getPresence } from "../../entrypoints/discord/monitor/presence-cache.js";
import {
  addRoleDiscord,
...
} from "../../entrypoints/discord/send.js";
import {
  type ActionGate,
  jsonResult,
  readNumberParam,
