...
import { applyPluginAutoEnable } from "../infra/config/plugin-auto-enable.js";
...
vi.mock("../infra/config/sessions.js", async () => {
  const actual = await vi.importActual<typeof import("../infra/config/sessions.js")>(
    "../infra/config/sessions.js",
  );
  return {
    ...actual,
...
vi.mock("../infra/config/config.js", async () => {
  const actual = await vi.importActual<typeof import("../infra/config/config.js")>(
    "../infra/config/config.js",
  );
...
vi.mock("../extensibility/plugins/loader.js", async () => {
  const actual = await vi.importActual<typeof import("../extensibility/plugins/loader.js")>(
    "../extensibility/plugins/loader.js",
  );
  return {
    ...actual,
