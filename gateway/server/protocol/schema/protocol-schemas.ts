...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  AgentsPiConfigParams: AgentsPiConfigParamsSchema,
  AgentsPiConfigResult: AgentsPiConfigResultSchema,
  AgentsListParams: AgentsListParamsSchema,
  AgentsListResult: AgentsListResultSchema,
  AgentsOnboardingResetParams: AgentsOnboardingResetParamsSchema,
  AgentsOnboardingResetResult: AgentsOnboardingResetResultSchema,
