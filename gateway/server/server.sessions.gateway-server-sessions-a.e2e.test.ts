...
vi.mock("../pipeline/reply/queue.js", async () => {
  const actual = await vi.importActual<typeof import("../pipeline/reply/queue.js")>(
    "../pipeline/reply/queue.js",
  );
  return {
    ...actual,
...
vi.mock("../pipeline/reply/abort.js", async () => {
  const actual = await vi.importActual<typeof import("../pipeline/reply/abort.js")>(
    "../pipeline/reply/abort.js",
  );
  return {
    ...actual,
