...
export type AgentDefaultsConfig = {
  ...
  /** Tiered model routing: Phase 1 classifies stay/escalate; when stay, override to classifier model. */
  routing?: {
    /** Enable routing (Phase 1 gate + classifier model override when stay). */
    enabled?: boolean;
