...
import type { MsgContext } from "../gateway/agent/pipeline/templating.js";
import type { OpenClawConfig } from "../gateway/infra/config/config.js";
...
const loadApply = async () => {
  vi.resetModules();
  return await import("../gateway/agent/media-understanding/apply.js");
};
